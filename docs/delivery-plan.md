...
- **Audit** — готовый Spring Boot-сервис централизованного аудита (см. [`backend/audit/README.md`](../backend/audit/README.md)), получает события из RabbitMQ и предоставляет REST API для администрирования.
