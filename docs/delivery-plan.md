...
- **Reports** — FastAPI-сервис агрегированных отчётов по материализованным представлениям CRM/Audit (в первой поставке — базовые показатели сделок и активностей).
...
1. **Этап 1.1 (улучшения после запуска)**
   ...
   - Расширенные массовые действия в списке сделок (API и UX) поверх нового интерфейса списка.
2. **Этап 2.0**
