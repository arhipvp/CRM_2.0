...
- **CRM/Deals** — клиенты, сделки, расчёты, полисы, журнал активности и задачи первого уровня (ручное назначение, без SLA и автоматических сценариев). Учёт оплат полностью ведётся внутри CRM: платежи и связанные движения (доходы/расходы) фиксируются вручную ответственными пользователями непосредственно в системе.
...
- Продавец и исполнитель фиксируют все типы платежей (премии, комиссии, скидки, выплаты) в рамках своих сделок: допускается несколько записей по полису, каждая из которых содержит детализированные позиции доходов и расходов с фактическими датами и ответственными пользователями.
