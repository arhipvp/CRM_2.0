...
- Node.js 20 LTS и pnpm 9 (через Corepack) для фронтенда на Next.js 15 / React 19. Установите LTS-версию Node.js с сайта [nodejs.org](https://nodejs.org) или через менеджер версий, затем выполните подготовку менеджера пакетов:
