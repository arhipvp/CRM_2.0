...
- **Подтверждённые оплаты:** отображает фактическую дату поступления средств и сотрудника, подтвердившего платёж в CRM; блок обновляется вместе с карточкой сделки, отдельный SSE-канал не требуется.
