...
Макеты и спецификации интерфейсов поддерживаются прямо в репозитории. Для каждого экрана создаётся подпапка в `docs/frontend/mockups`, содержащая Markdown-спецификацию и, при наличии, статичные изображения (предпочтительно SVG/WebP). Новые материалы по «Воронке сделок» включают иллюстрации для списка стадий, предпросмотра и массовых действий. Для остальных экранов временно доступны только текстовые описания состояний. При добавлении нового состояния обновляйте соответствующие документы и прикладывайте актуальные артефакты в каталог макетов.
