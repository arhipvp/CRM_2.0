...
## Дизайн-токены
- **Расположение**: значения токенов версионируются в каталоге `frontend/app/design-tokens/`.
- **Обновление**: при изменении цветов, типографики или отступов редактируйте соответствующие JSON/TS-файлы и синхронизируйте использование токенов в компонентах.
- **Контроль изменений**: каждое обновление токенов сопровождайте кратким описанием в PR и ссылкой на задачу, повлекшую изменение визуального стиля.
