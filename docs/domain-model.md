...
- Администратор имеет права только на просмотр задач, что соответствует политике доступа из раздела «Правила безопасности и доступа».
- Изменение исполнителя или дедлайна фиксируется постановщиком через карточку задачи; система автоматически сохраняет предыдущие значения и автора изменения в Audit и отображает запись в истории задачи.
