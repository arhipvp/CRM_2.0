...
- После ввода даты продавец может скорректировать сумму и комментарий (например, если в банк загрузили уточнённые реквизиты). Все изменения сохраняются в аудите CRM вместе с автором и временем правки.
