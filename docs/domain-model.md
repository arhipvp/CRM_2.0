...
| Ожидается | Счёт выставлен, ожидается подтверждение поступления/списания. | Продавец или исполнитель фиксирует отправку счёта либо подтверждение от клиента. |
...
| Выплачен | Вся сумма перечислена дальше (комиссия агенту, скидка клиенту, выплата исполнителю). | Финансовый менеджер подтверждает исходящий платёж или распределение комиссии без дробления суммы. |
...
- Продавец управляет задачами в рамках своих сделок как постановщик: создаёт, отменяет, возвращает на доработку, изменяет исполнителя и срок исполнения.
