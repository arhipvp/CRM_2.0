...
Внутренние справочники тарифов, управляемые через административные инструменты CRM
...
Первая поставка ограничивается ручным созданием и назначением задач без SLA-таймеров, повторяющихся задач и cron-триггеров; эти возможности запланированы на Этап 1.1.
