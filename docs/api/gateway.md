...
| `/{version}/payments/*` | `GATEWAY_UPSTREAM_PAYMENTS_BASE_URL` | Финансовые операции | Используется для CRUD и сервисных эндпоинтов Payments.【F:backend/gateway/src/http/payments/payments.controller.ts†L1-L22】 |
