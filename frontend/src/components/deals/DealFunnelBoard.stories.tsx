...
const meta: Meta<typeof DealFunnelBoard> = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "См. спецификацию в docs/frontend/deal-funnel.md. Плавающая панель массовых действий появляется при выборе карточек и выводит заглушку с сообщением о переносе операций в релиз 1.1.",
      },
    },
  },
};
...
export const BulkActionsPanel: StoryObj<typeof DealFunnelBoard> = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Стейт с активированной панелью массовых действий: выбрано несколько карточек, отображается плавающая панель с сообщением о переносе функциональности и кнопкой «Понятно».",
      },
    },
  },
};
