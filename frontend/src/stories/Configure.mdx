...
<div className="sb-container">
  ...
  <div className="sb-section">
    <div className="sb-features-grid">
      ...
      <div className="sb-grid-item">
        <div className="sb-placeholder" aria-hidden="true">
          <span className="sb-placeholder-badge">Tip</span>
          <span className="sb-placeholder-graphic" />
        </div>
        <h4 className="sb-section-item-heading">Design review checklist</h4>
        <p className="sb-section-item-paragraph">Share stories with your design team and capture feedback in one place before shipping updates.</p>
        <a
          href="https://storybook.js.org/docs/sharing/publish-storybook/?renderer=react"
          target="_blank"
        >See collaboration tips<RightArrow /></a>
      </div>
      <div className="sb-grid-item">
        <Image
          width={0}
...
<style>
  ...
  .sb-placeholder {
    ...
    padding: 16px;
    border-radius: 8px;
    background: linear-gradient(135deg, rgba(9, 81, 150, 0.15), rgba(9, 81, 150, 0.35));
    overflow: hidden;
  }
  ...
  .sb-placeholder-badge {
    ...
    box-shadow: 0 1px 3px rgba(9, 79, 150, 0.25);
  }

  .sb-placeholder-graphic {
    position: absolute;
    right: -30px;
    bottom: -40px;
    width: 140px;
    height: 140px;
    border-radius: 999px;
    background: rgba(9, 79, 150, 0.15);
    border: 2px solid rgba(9, 79, 150, 0.4);
