...
Платежи (модуль CRM). Учёт входящих оплат по полисам, подтверждение фактической даты, комментарии продавца и аудит изменений. Модуль платежей CRM заменил прежний сервис Payments и обслуживает операции внутри CRM/Deals.
