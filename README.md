...
Audit (архив). Отдельный сервис централизованного аудита выведен из эксплуатации и удалён из репозитория; историческую документацию можно найти в ветках до удаления. Контур журналирования поддерживается на уровне прикладных сервисов и витрин Reports.
