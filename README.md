...
Gateway/BFF. Общая точка входа для фронтенда, управление сессиями, маршрутизация запросов к сервисам, агрегация данных (подробнее см. раздел [«Фронтенд» технологического стека](docs/tech-stack.md#фронтенд)). Фронтенд использует REST API шлюза и SSE-каналы для событийных обновлений.
