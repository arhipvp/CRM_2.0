...
TRANSLATIONS_RU = {
    ...
    "Yes": "Да",
    "Subject": "Тема",
    "Assignee ID": "Исполнитель",
    "Author ID": "Постановщик",
    "All": "Все",
    "Files": "Файлы",
    ...
    "Invalid deal selected.": "Выбрана неверная сделка.",
    "Invalid client selected.": "Выбран неверный клиент.",
    "Subject cannot be empty.": "Тема не может быть пустой.",
    "Description cannot be empty.": "Описание не может быть пустым.",
    "Assignee must be selected.": "Необходимо выбрать исполнителя.",
    "Author must be selected.": "Необходимо выбрать постановщика.",
